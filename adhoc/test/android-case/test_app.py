...
class MyTests(unittest.TestCase):
    ...
    def setUp(self):
        desired_caps = {'platformName': 'Android', # 平台名称
                        ...
                        'deviceName': '127.0.0.1:5554',  # 设备名称。如果是真机，在'设置->关于手机->设备名称'里查看
                        'app':APK_PATH+ '\AbTestDemo-debug1.apk',
                        'appPackage': 'com.abtestdemo',  # apk的包名
                        'appActivity': 'com.example.adhoc.abtestdemo.MainActivity'  # activity 名称
                        }
